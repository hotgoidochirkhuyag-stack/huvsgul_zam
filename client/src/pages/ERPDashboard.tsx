  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white">
      ...
      <div className="border-b border-white/10 px-8 py-4 flex items-center justify-between">
        ...
        <button onClick={() => { localStorage.removeItem("adminToken"); localStorage.removeItem("userRole"); setLocation("/select-role"); }} className="flex items-center gap-2 px-4 py-2 bg-red-600/20 text-red-400 hover:bg-red-600/30 rounded-xl text-sm transition-all">
