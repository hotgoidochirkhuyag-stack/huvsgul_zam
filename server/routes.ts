...
Зөвхөн цэвэр JSON буцаа. Үнийг Монгол төгрөгөөр бич. Нийт дүнг quantity=${qty}-р үржүүлж тооцоол.`;
  ...
  const SKILL_SEED: { category: string; name: string; sortOrder: number }[] = [
    ...
    { category: "🛣️ Зам барилга",       name: "Асфальт бетон хучилт (Asphalt concrete paving)",                sortOrder: 6  },
    { category: "🛣️ Зам барилга",       name: "Замын тоноглол, тэмдэглэгээ (Road marking & Furniture)",        sortOrder: 7  },
    ...
    { category: "🏗️ Бетон ажил",        name: "Бетон зуурмагийн үйлдвэрлэл (Mixing operation)",               sortOrder: 16 },
    { category: "🏗️ Бетон ажил",        name: "Зуурмагийн хөдөлгөөнт чанар шалгах (Slump test)",              sortOrder: 17 },
    { category: "🏗️ Бетон ажил",        name: "Арматурчлал — зүсэх, нугалах, зангидах (Rebar works)",         sortOrder: 18 },
    { category: "🏗️ Бетон ажил",        name: "Хэв хашмал угсралт, тосолгоо (Formwork / Shuttering)",          sortOrder: 19 },
    { category: "🏗️ Бетон ажил",        name: "Бетон цутгалт, нягтруулалт (Pouring & Vibration)",              sortOrder: 20 },
    { category: "🏗️ Бетон ажил",        name: "Бетоны арчилгаа — өвөл, зун (Curing)",                          sortOrder: 21 },
    // ── Техник хэрэгсэл (8) ──
    { category: "⚙️ Техник хэрэгсэл",   name: "Экскаватор — ухах, ачих",                                       sortOrder: 22 },
    { category: "⚙️ Техник хэрэгсэл",   name: "Бульдозер — түрхэх, түрж зайлуулах",                           sortOrder: 23 },
    { category: "⚙️ Техник хэрэгсэл",   name: "Автогрейдер — тэгшилгээ, хэлбэржүүлэлт",                       sortOrder: 24 },
    { category: "⚙️ Техник хэрэгсэл",   name: "Индүү — чичиргээт, дугуйт (Roller / Compactor)",               sortOrder: 25 },
    { category: "⚙️ Техник хэрэгсэл",   name: "Асфальт дэвсэгч (Paver) — хучилт хийх",                        sortOrder: 26 },
    { category: "⚙️ Техник хэрэгсэл",   name: "Автокран / Өөрөө ачигч (Crane / Man-lift)",                    sortOrder: 27 },
    { category: "⚙️ Техник хэрэгсэл",   name: "Бетон насос / Миксер (Concrete Pump / Truck Mixer)",           sortOrder: 28 },
    { category: "⚙️ Техник хэрэгсэл",   name: "Усны машин / Түлшний машин (Water/Fuel truck)",                sortOrder: 29 },
    // ── Менежмент & Бусад (5) ──
    { category: "📋 Менежмент & Бусад", name: "Төсөв, нормчлол — Norm (Estimating)",                           sortOrder: 30 },
    { category: "📋 Менежмент & Бусад", name: "ХАБЭА — Хөдөлмөрийн аюулгүй байдал (OSHA)",                    sortOrder: 31 },
    { category: "📋 Менежмент & Бусад", name: "Төслийн төлөвлөлт — MS Project (Scheduling)",                   sortOrder: 32 },
    { category: "📋 Менежмент & Бусад", name: "Техникийн баримт бичиг — ил далд акт, журнал",                  sortOrder: 33 },
    { category: "📋 Менежмент & Бусад", name: "Геодезийн хэмжилт, боловсруулалт (Civil 3D / Topo software)",  sortOrder: 34 },
  ];
