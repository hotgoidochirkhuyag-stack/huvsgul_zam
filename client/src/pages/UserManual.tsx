...
const SECTIONS: Section[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        desc: "Харьяалал сонгосны дараа нэвтрэх нэр болон нууц үгийг оруулна. Анхдагч: admin / admin.\nАдминистратор самбарын «Нэвтрэх мэдээлэл» таб дотроос харьяалал бүрийн нууц үгийг солих боломжтой.",
        tip: "Нууц үгийг мэдэхгүй бол Администратортай холбогдоно уу.",
      },
      {
        title: "4. Самбар нээгдэх",
        desc: "Амжилттай нэвтэрсний дараа таны харьяалалын самбар автоматаар нээгдэнэ.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        desc: "«Нэвтрэх мэдээлэл» таб:\n• Харьяалал бүрийн нэвтрэх нэр, нууц үгийг өөрчилнэ\n• «Засах» товч → шинэ нэр/нууц үг оруулна → «Хадгалах»\n\nАнхдагч нуут үгийг заавал солих хэрэгтэй!",
        tip: "Нийт 9 харьяалал тус бүрт тусдаа нэвтрэх мэдээлэл тохируулж болно.",
      },
      {
      ...
      },
      {
        ...
        desc: "«Бүртгэл» таб:\n• Хэн хэзээ нэвтэрсэн\n• Амжилтгүй нэвтрэх оролдлого\n• IP хаяг, харьяалал бүрийн нэвтрэлтийн түүх\n• Харьяалал бүрээр шүүж харах боломжтой",
      },
      {
...
export default function UserManual() {
  ...
  const filtered = activeRole === "Бүгд"
    ? SECTIONS
    : SECTIONS.filter(s => s.roles.some(r => r === activeRole || r === "Бүх харьяалал" || r === "Бүх ажилтан"));
    ...
    <div className="min-h-screen bg-[#020617] text-white">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-slate-300 text-sm leading-relaxed">
                Хөвсгөл зам ХХК-ийн ERP систем нь <strong className="text-white">9 харьяалал</strong>-той хэрэглэгчдийг дэмждэг.
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-8">
          {[
            { icon: <Users className="w-4 h-4" />, label: "Нийт харьяалал", value: "9", color: "text-blue-400" },
        ...
        {/* Role filter */}
        <div className="mb-6">
          <p className="text-slate-400 text-sm mb-3">Харьяалал сонгоод өөрт хамаарах зааврыг харна уу:</p>
